...
\begin{itemize}
    ...
    \item If $r_t$ is independent of the sign of $\hat{G}_t$, this is a harder
        condition to meet, so penalties become more possible, allowing
        $L^{CLIP}(\theta)$ to better approximate $targ_{g}(\theta)$.
