...
\pgfmathsetmacro{\epsu}{0.9}
\pgfmathsetmacro{\epsugr}{0.1}
...
\foreach \mult in {0,1,...,55}
{
    ...
    \begin{tikzpicture}
        ...
        \ifnum \valid = 1
            ...
            \pgfmathsetmacro{\terma}{\epsd + ((1 - \epsd) * \inta)}
            \pgfmathsetmacro{\termb}{\intb + ((\epsd + \epsu) * \intc)}
    ...
    %\pgfmathsetmacro{\epsu}{\epsu + \epsugr}
}
\end{document}
